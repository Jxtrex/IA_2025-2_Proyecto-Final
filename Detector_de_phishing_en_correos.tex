...
\bibitem{b8}
Bergholz, A., De Beer, J., Glahn, S., Moens, M.-F., Paaß, G., \& Strobel, S. (2010).
...
\textit{Proceedings of NAACL-HLT}.

\bibitem{b11}
Garera, S., Provos, N., Chew, M., \& Rubin, A. D. (2007).
A framework for detection and measurement of phishing attacks.
\textit{Proceedings of the 2007 ACM Workshop on Recurring Malcode}.
...
\textit{Proceedings of the 22nd ACM SIGKDD Conference on Knowledge Discovery and Data Mining (KDD)}.
